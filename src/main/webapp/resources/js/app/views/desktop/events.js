define([
    ...
    var EventSummaryLineView = Backbone.View.extend({
        ...
        render:function () {
            utilities.applyTemplate($(this.el), eventSummaryTemplate, this.model.attributes)
            return this;
        },
        notify:function () {
    ...
    var EventSummaryView = Backbone.View.extend({
        render:function () {
            utilities.applyTemplate($(this.el), eventCarouselTemplate, {models:this.model.models});
