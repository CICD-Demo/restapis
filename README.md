...
* `demo` - the sources of TicketMonster application - you can build and run it! Or you can see it at work [here](http://ticketmonster-jdf.rhcloud.com). Follow the [instructions](demo/README.md).
