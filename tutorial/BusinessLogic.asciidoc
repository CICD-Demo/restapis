...
Verify that the property `jboss.bom.version` contains the value `6.2.3.GA` or higher:
...
.src/main/java/org/jboss/jdf/example/ticketmonster/model/Section.java
[source,java]
------------------------------------------------------------------------------------------
...
...
.src/main/java/org/jboss/jdf/example/ticketmonster/model/TicketPrice.java
[source,java]
------------------------------------------------------------------------------------------
...
@JsonIgnoreProperties("show")
