...
After ensuring that the `JBOSS_HOME` environment variable is set to a valid JBoss EAP 6.1 installation directory), you can run the following command:

----
mvn clean test -Parq-jbossas-managed
----

Or, after starting a JBoss EAP 6.1 instance, you can run the following command
