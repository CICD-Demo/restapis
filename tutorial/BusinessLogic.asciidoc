...
Verify that the property `jboss.bom.version` contains the value `1.0.4.Final-redhat-4` or higher:
...
<project ...>  
    ...
    <properties>
        ...
        <jboss.bom.version>1.0.4.Final-redhat-4</jboss.bom.version>
        ...
    </properties>
    ...
</project>
...
* all classes from the `org.jboss.jdf.example.ticketmonster.util` package,
