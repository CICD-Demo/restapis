...
* RESTful services are mainly used by the Plain Old HTML5 user interface
...
As a note, we call this 'command line' because this is the most simple way to run them.
However, it is important to re-emphasize the fact that these tests execute as part of a
