...
Reducing coupling is a critical goal for a well-designed architecture. You can focus now
...
You can execute your tests in two ways:

* from the command-line Maven build
* from an IDE
