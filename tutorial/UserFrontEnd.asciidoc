...
project. You can also copy the files referenced in `home.html`, from the project sources:

* `src/main/webapp/resources/img/glyphicons_163_iphone.png`
* `src/main/webapp/resources/img/glyphicons_232_cloud.png`
* `src/main/webapp/resources/img/glyphicons_351_book_open.png`
* `src/main/webapp/resources/img/jdf_mark_50px.png`
* `src/main/webapp/resources/img/GitHub_Logo.png`
* `src/main/webapp/resources/img/splash-ticketmonster.png`
* `src/main/webapp/resources/img/glyphicons_019_cogwheel.png`
