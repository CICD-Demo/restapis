...
To run the project on an emulator, in the *Project Explorer* view, right-click the project name and click *Run As* → *Run on Android Emulator*. This requires that you create an Android AVD to run the application in a virtual device.
